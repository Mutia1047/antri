<div class="row">
	<div class="col-lg-12">
		<h1><small>Data Karyawan</small></h1>
		<ol class="breadcrumb">
			<li>Admin</li>
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="card shadow mb-4">
			<div class="card-body ">
				<div>
					<a href="#add" class="btn btn-primary" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Tambah Karyawan</a><br><br>
				</div>
											...
											<form method="POST" action="<?php echo site_url('admin/edit_karyawan/'); ?>" enctype="multipart/form-data">
												...
												<div class="col-md-6">
													...
													<select name="level" class="form-control" required="" onchange="cek()" id="lev">
														...
														<option value="Penjaga" <?php echo $selected1; ?>>Penjaga Loket
														</option>
													</select>
													...
													<select name="id_loket" class="form-control" id="id_loket">
														<option value="<?php echo $el->id_loket; ?>">
															<?php echo $el->loket; ?></option>
														<?php

														$loketnot = $this->M_crud->get_id('loket', array('id_loket <>' => $row->id_loket));
														foreach ($loketnot->result() as $lo) { ?>
															<option value="<?php echo $lo->id_loket; ?>">
																<?php echo $lo->loket; ?></option>
														<?php } ?>
													</select>
